    ...
    return (
        <main className="p-8 space-y-8">
            ...
            <BulkImportModal
                ...
                title="Bulk Import Athletes"
                entityName="Athletes"
                endpoint="http://localhost:3001/api/athletes/bulk-import"
                onSuccess={fetchAthletes}
                templateHeaders="name, gender, category, age, schoolId, personalBest"
                sampleData="John Doe, MALE, U17, 15, school-uuid-here, 11.2s"
            />
