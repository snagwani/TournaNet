                            ...
                            <tbody>
                                {isLoading ? (
                                    ...
                                    events.map((event) => {
                                        ...
                                        return (
                                            <tr key={event.eventId} className="border-b border-neutral-800/50 hover:bg-white/[0.02] transition-colors group">
                                                ...
                                                {[event.gold, event.silver, event.bronze].map((medalist, idx) => (
                                                    <td key={idx} className="px-6 py-6 text-center">
                                                        {medalist ? (
                                                            ...
                                                            <span className="text-neutral-800 font-mono text-[10px]">—</span>
                                                        )}
                                                    </td>
                                                ))}
                                            </tr>
